...
def get_booking_df():
    return get_df(form_booking_df_from_path, "BookingScraper", "data/Bookingdataframes.csv")

def get_airbnb_df():
    return get_df(form_airbnb_df_from_path, "AirbnbScraper", "data/airbnbdataframes.csv")

def get_special_df():
    return get_df(form_booking_df_from_path, "SpecialBookingScraper", "data/specialdataframes.csv")
